...
**Files:**
- Create: `src/main/resources/db/migration/V021__public_booking_customer_auth.sql`
...
- [ ] Run `mvn -q "-Dtest=PublicBookingMigrationTest" test` and confirm it fails because `V021__public_booking_customer_auth.sql` does not exist.
