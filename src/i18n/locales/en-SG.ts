export const enSG = {
  ...
  reservationWorkbench: {
    ...
    tableAssignment: {
      action: 'Assign table',
      aria: 'Assign a table to reservation',
      title: 'Assign table',
      close: 'Close table assignment',
      currentReservation: 'Current reservation',
      subject: 'Reserve a table for {customer} ({count} pax)',
      instruction: 'Only capacity-matched tables without an overlapping reservation are shown. Use the existing share actions after assignment.',
      loading: 'Loading assignable tables…',
      empty: 'No assignable tables',
      emptyHint: 'Refresh later, or check table capacity and reservations in the same time slot.',
      unassignedArea: 'Unassigned area',
      capacity: 'Capacity {min}-{max}',
      selected: 'Selected: {code}',
      selectPrompt: 'Select one table',
      confirm: 'Confirm assignment',
      submitting: 'Assigning…',
      refresh: 'Refresh tables',
      conflict: 'The table was just taken or the reservation changed. The list has been refreshed; please select again.',
      forbidden: 'Your account cannot assign reservation tables.',
      loadOrSubmitFailed: 'Unable to assign the table. Refresh and try again.',
