...
public class CustomerAuthCookieService {
    public static final String COOKIE_NAME = "RPB_CUSTOMER_SESSION";

    private final boolean secureCookie;

    public CustomerAuthCookieService(@Value("${rpb.customer-auth.cookie-secure:false}") boolean secureCookie) {
