...
@Component
public class ReservationArrivedToQueueApiErrorMapper {

    public ResponseEntity<ReservationApiErrorResponse> toResponse(ReservationArrivedToQueueResult result) {
    ...
    private ReservationApiErrorCode toApiErrorCode(ReservationArrivedToQueueError error) {
        return switch (error) {
            ...
            case RESERVATION_CANNOT_QUEUE_SEATED -> ReservationApiErrorCode.RESERVATION_CANNOT_QUEUE_SEATED;
            case RESERVATION_CANNOT_QUEUE_CANCELLED -> ReservationApiErrorCode.RESERVATION_CANNOT_QUEUE_CANCELLED;
            case RESERVATION_CANNOT_QUEUE_NO_SHOW -> ReservationApiErrorCode.RESERVATION_CANNOT_QUEUE_NO_SHOW;
            case RESERVATION_CANNOT_QUEUE_COMPLETED -> ReservationApiErrorCode.RESERVATION_CANNOT_QUEUE_COMPLETED;
            case QUEUE_GROUP_NOT_FOUND -> ReservationApiErrorCode.QUEUE_GROUP_NOT_FOUND;
            case QUEUE_GROUP_CANNOT_BE_DERIVED -> ReservationApiErrorCode.QUEUE_GROUP_CANNOT_BE_DERIVED;
            case QUEUE_GROUP_PARTY_SIZE_MISMATCH -> ReservationApiErrorCode.QUEUE_GROUP_PARTY_SIZE_MISMATCH;
            case QUEUE_TICKET_NUMBER_CONFLICT -> ReservationApiErrorCode.QUEUE_TICKET_NUMBER_CONFLICT;
            case ACTIVE_QUEUE_TICKET_CONFLICT -> ReservationApiErrorCode.ACTIVE_QUEUE_TICKET_CONFLICT;
