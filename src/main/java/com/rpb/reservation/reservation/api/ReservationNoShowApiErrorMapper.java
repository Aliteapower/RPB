...
@Component
public class ReservationNoShowApiErrorMapper {

    public ResponseEntity<ReservationApiErrorResponse> toResponse(ReservationNoShowResult result) {
    ...
    private ReservationApiErrorCode toApiErrorCode(ReservationNoShowError error) {
        return switch (error) {
            ...
            case RESERVATION_CANNOT_NO_SHOW_DRAFT -> ReservationApiErrorCode.RESERVATION_CANNOT_NO_SHOW_DRAFT;
            case RESERVATION_CANNOT_NO_SHOW_SEATED -> ReservationApiErrorCode.RESERVATION_CANNOT_NO_SHOW_SEATED;
            case RESERVATION_CANNOT_NO_SHOW_CANCELLED -> ReservationApiErrorCode.RESERVATION_CANNOT_NO_SHOW_CANCELLED;
            case RESERVATION_CANNOT_NO_SHOW_COMPLETED -> ReservationApiErrorCode.RESERVATION_CANNOT_NO_SHOW_COMPLETED;
