...
public class ReservationArrivedDirectSeatingApiErrorMapper {
    ...
    private ReservationApiErrorCode toApiErrorCode(ReservationArrivedDirectSeatingError error) {
        return switch (error) {
            ...
            case TEMPORARY_TABLE_GROUP_MEMBER_REQUIRED -> ReservationApiErrorCode.TEMPORARY_TABLE_GROUP_MEMBER_REQUIRED;
            case TEMPORARY_TABLE_GROUP_MEMBER_DUPLICATE -> ReservationApiErrorCode.TEMPORARY_TABLE_GROUP_MEMBER_DUPLICATE;
            case TEMPORARY_TABLE_GROUP_MEMBER_UNAVAILABLE -> ReservationApiErrorCode.TEMPORARY_TABLE_GROUP_MEMBER_UNAVAILABLE;
            case TEMPORARY_TABLE_GROUP_CAPACITY_INSUFFICIENT -> ReservationApiErrorCode.TEMPORARY_TABLE_GROUP_CAPACITY_INSUFFICIENT;
            case TEMPORARY_TABLE_GROUP_LOCK_CONFLICT -> ReservationApiErrorCode.TEMPORARY_TABLE_GROUP_LOCK_CONFLICT;
            case TEMPORARY_TABLE_GROUP_PREASSIGNMENT_CONFLICT -> ReservationApiErrorCode.TEMPORARY_TABLE_GROUP_PREASSIGNMENT_CONFLICT;
