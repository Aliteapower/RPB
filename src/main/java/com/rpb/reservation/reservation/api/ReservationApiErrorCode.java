...
public enum ReservationApiErrorCode {
    ...
    RESERVATION_CANNOT_CANCEL_ARRIVED(HttpStatus.CONFLICT, "reservation.cannot_cancel_arrived"),
    RESERVATION_CANNOT_CANCEL_SEATED(HttpStatus.CONFLICT, "reservation.cannot_cancel_seated"),
    RESERVATION_CANNOT_CANCEL_NO_SHOW(HttpStatus.CONFLICT, "reservation.cannot_cancel_no_show"),
    RESERVATION_CANNOT_CANCEL_COMPLETED(HttpStatus.CONFLICT, "reservation.cannot_cancel_completed"),
    RESERVATION_CANNOT_NO_SHOW_DRAFT(HttpStatus.CONFLICT, "reservation.cannot_no_show_draft"),
    RESERVATION_CANNOT_NO_SHOW_SEATED(HttpStatus.CONFLICT, "reservation.cannot_no_show_seated"),
    RESERVATION_CANNOT_NO_SHOW_CANCELLED(HttpStatus.CONFLICT, "reservation.cannot_no_show_cancelled"),
    RESERVATION_CANNOT_NO_SHOW_COMPLETED(HttpStatus.CONFLICT, "reservation.cannot_no_show_completed"),
    RESERVATION_CANNOT_COMPLETE_DRAFT(HttpStatus.CONFLICT, "reservation.cannot_complete_draft"),
    RESERVATION_CANNOT_COMPLETE_CONFIRMED(HttpStatus.CONFLICT, "reservation.cannot_complete_confirmed"),
    RESERVATION_CANNOT_COMPLETE_ARRIVED(HttpStatus.CONFLICT, "reservation.cannot_complete_arrived"),
    RESERVATION_CANNOT_COMPLETE_CANCELLED(HttpStatus.CONFLICT, "reservation.cannot_complete_cancelled"),
    RESERVATION_CANNOT_COMPLETE_NO_SHOW(HttpStatus.CONFLICT, "reservation.cannot_complete_no_show"),
    RESERVATION_COMPLETED_WITHOUT_ACTIVE_SEATING(HttpStatus.CONFLICT, "reservation.completed_without_active_seating"),
