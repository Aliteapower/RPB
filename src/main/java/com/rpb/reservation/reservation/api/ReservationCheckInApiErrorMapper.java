...
@Component
public class ReservationCheckInApiErrorMapper {

    public ResponseEntity<ReservationApiErrorResponse> toResponse(ReservationCheckInResult result) {
    ...
    private ReservationApiErrorCode toApiErrorCode(ReservationCheckInError error) {
        return switch (error) {
            ...
            case RESERVATION_CANNOT_CHECK_IN_SEATED -> ReservationApiErrorCode.RESERVATION_CANNOT_CHECK_IN_SEATED;
