...
public enum TenantAdminApiErrorCode {
    ...
    CUSTOMER_NOT_FOUND(HttpStatus.NOT_FOUND, "tenant.admin.customer_not_found"),
    ...
    CUSTOMER_PHONE_CONFLICT(HttpStatus.CONFLICT, "tenant.admin.customer_phone_conflict"),
