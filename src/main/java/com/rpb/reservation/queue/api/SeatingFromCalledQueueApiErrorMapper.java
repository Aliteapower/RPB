...
public class SeatingFromCalledQueueApiErrorMapper {
    ...
    private SeatingFromCalledQueueApiErrorCode toApiErrorCode(SeatingFromCalledQueueError error) {
        return switch (error) {
            ...
            case TEMPORARY_TABLE_GROUP_MEMBER_REQUIRED -> SeatingFromCalledQueueApiErrorCode.TEMPORARY_TABLE_GROUP_MEMBER_REQUIRED;
            case TEMPORARY_TABLE_GROUP_MEMBER_DUPLICATE -> SeatingFromCalledQueueApiErrorCode.TEMPORARY_TABLE_GROUP_MEMBER_DUPLICATE;
            case TEMPORARY_TABLE_GROUP_MEMBER_UNAVAILABLE -> SeatingFromCalledQueueApiErrorCode.TEMPORARY_TABLE_GROUP_MEMBER_UNAVAILABLE;
            case TEMPORARY_TABLE_GROUP_CAPACITY_INSUFFICIENT -> SeatingFromCalledQueueApiErrorCode.TEMPORARY_TABLE_GROUP_CAPACITY_INSUFFICIENT;
            case TEMPORARY_TABLE_GROUP_LOCK_CONFLICT -> SeatingFromCalledQueueApiErrorCode.TEMPORARY_TABLE_GROUP_LOCK_CONFLICT;
            case TEMPORARY_TABLE_GROUP_PREASSIGNMENT_CONFLICT -> SeatingFromCalledQueueApiErrorCode.TEMPORARY_TABLE_GROUP_PREASSIGNMENT_CONFLICT;
