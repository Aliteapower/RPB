...
public enum QueueSkipError {
    ...
    QUEUE_SKIP_EVIDENCE_INCOMPLETE("queue_skip_evidence_incomplete"),
    ...
    private static final Map<String, QueueSkipError> ALIASES = Map.of(
        "command_in_progress", IDEMPOTENCY_IN_PROGRESS
    );

    private final String code;

    QueueSkipError(String code) {
        this.code = code;
    }
    ...
    public static QueueSkipError fromCode(String code) {
