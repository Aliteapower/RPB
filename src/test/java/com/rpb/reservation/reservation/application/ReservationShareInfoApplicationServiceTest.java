...
class ReservationShareInfoApplicationServiceTest {
    ...
    void fallsBackToDefaultTemplateWhenStoredTemplateContainsUnknownVariable() {
        ...
        assertThat(result.shareInfo().shareText())
            .contains("Dear Ada Guest 先生/女士")
            .contains("Thank you for choosing 食刻订位中心")
            .contains("Booking no.: R-20300620-0007")
            .contains("Date: 20-06-2030")
            .contains("Time: 11:30")
            .contains("Party size: 4 pax")
            .contains("Table: A01 (reserved)")
            .contains("we will hold your table for 15 minutes")
            .contains("Arrival note: 请提前 10 分钟到店")
            .contains("Store address: 1 Example Road")
            .contains("Contact phone: 6333 1234")
            .contains("To change or cancel, please contact the store at least 2 hours ahead.")
            .contains("食刻订位中心 Reservations")
