...
class PublicBookingUiValidationTest {
    ...
    void tenantAdminPublicBookingPageUsesProjectOperationPanelsForConfiguration() throws Exception {
        ...
        assertThat(tenantAdminPublicBookingPageSource)
            ...
            .contains("const weekdayValidationAttempted = ref(false)")
            .contains("const showWeekdayRequired = computed(() =>")
            .contains("weekdayValidationAttempted.value &&")
            .contains("watch(() => selectedWeekdays.value.length")
            .contains("clearWeekdayRequiredError()")
            .contains("function clearWeekdayRequiredError()")
            ...
            .contains("周一")
            .contains("周日")
            .contains("v-if=\"showWeekdayRequired\"")
            .contains("至少选择一个星期")
            .contains("选择餐段")
