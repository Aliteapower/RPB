...
class PlatformProductLineBillingUiImplementationValidationTest {
    ...
    void platformBillingPagesUseManualBillingApisAndExposeLoadingErrorSavingStates() throws Exception {
        ...
        assertThat(api)
            ...
            .contains("renewProductSubscriptionItem")
        ...
        assertThat(types)
            ...
            .contains("billingCycle: ProductBillingCycle | null")
            .contains("currentPeriodEnd: string | null")
        ...
        assertThat(tenantBillingPage)
            ...
            .contains("selectStoreItem")
            .contains("quoteStoreCount")
            ...
            .contains("platform.billing.actions.renewStore")
            .contains("<strong class=\"product-line-name\">{{ row.productLine.displayName }}</strong>")
            .contains("<section v-if=\"singleStoreRenewalMode\" class=\"store-items\"")
            .contains("@click=\"selectStoreItem(item)\"")
            .contains("loading")
            .contains("errorText")
            .contains("saving")
            .doesNotContain("suspendProductSubscription")
            .doesNotContain("cancelProductSubscription")
            .doesNotContain("toggleProductLine")
            .doesNotContain("isProductLineChecked")
            .doesNotContain("@change=\"toggleProductLine(row, $event)\"")
            .doesNotContain("type=\"checkbox\"")
            .doesNotContain("platform.billing.table.columns.actions")
