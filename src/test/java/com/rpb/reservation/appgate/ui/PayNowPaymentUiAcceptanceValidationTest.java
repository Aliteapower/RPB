...
class PayNowPaymentUiAcceptanceValidationTest {
    ...
    void payNowPagesUseRpbNativePaymentApiAndQrComponent() throws Exception {
        ...
        assertThat(quickPayReport)
            ...
            .contains("detailLoading")
            .contains("selectedDetailStatus")
            .contains("detailRecords")
            .contains("loadReportDetails")
            .contains("status: selectedDetailStatus.value")
            .contains("selectDetailStatus('paid')")
            .contains("selectDetailStatus('pending')")
            .contains("selectDetailStatus('awaiting_verification')")
            ...
            .contains("record.paymentReference")
            .contains("record.cashierName")
            .contains("dateTime(record.createdAt)")
            .contains("record.sessionNo")
            .contains("active-tab=\"payment\"")
            .contains("payment-quick-pay")
            .contains("formatAppGateErrorMessage")
            .contains("appgate.permission_denied")
        ...
        assertThat(proofReview)
            ...
            .contains("findPaymentPresentPayment")
            .contains("resolveSuccessfulCandidate")
            .contains("resolveSuccessfulAmount")
            .contains("const localPresentPayment = findPaymentPresentPayment(")
            .contains("successfulCandidate?.displayNumber || localPresentPayment?.displayNumber || null")
            .contains("resolveSuccessfulAmount(result, successfulCandidate, localPresentPayment)")
            .contains("const sessionNoToConfirm = successfulCandidate?.sessionNo || localPresentPayment?.sessionNo")
            .contains("result.paymentReference || successfulCandidate?.paymentReference || localPresentPayment?.paymentReference")
            .contains("const presentAmount = formatSpokenAmount(presentPayment?.amount || null)")
            .contains("return presentAmount")
            ...
            .doesNotContain("resolveSuccessfulAmount(result, successfulCandidate)\n")
        ...
        assertThat(generatedZh)
            ...
            .contains("\"generated.payment-quick-pay.076\": \"点击查看明细\"")
            .contains("\"generated.payment-quick-pay.077\": \"{status} 明细\"")
            .contains("\"generated.payment-quick-pay.078\": \"暂无明细\"")
        ...
        assertThat(generatedEn)
            ...
            .contains("\"generated.payment-quick-pay.076\": \"View details\"")
            .contains("\"generated.payment-quick-pay.077\": \"{status} details\"")
            .contains("\"generated.payment-quick-pay.078\": \"No details\"")
