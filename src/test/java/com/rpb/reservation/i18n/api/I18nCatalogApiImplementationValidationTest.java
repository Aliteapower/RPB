...
class I18nCatalogApiImplementationValidationTest {
    ...
    void apiKeepsPlatformAndTenantCatalogBoundariesExplicit() throws Exception {
        ...
        assertThat(tenantController)
            ...
            .contains("@RequestParam(required = false) String productLine")
            .contains("StoreScope scope")
            .contains("tenantCatalog(scope, productLine)")
            .contains("updateTenantCatalog(scope, scopeLevel(request), productLine, toCommands(request))")
            .doesNotContain("JdbcTemplate")
            .doesNotContain("i18n_message_catalog");

        assertThat(service)
            .contains("I18nCatalogRepository")
            .contains("TENANT_PRODUCT_LINE_NAMESPACES")
            .contains("\"payment\", Set.of(\"payment\")")
            .contains("\"reservation_queue\"")
            .contains("tenantCatalog(StoreScope scope, String productLine)")
            .contains("updateTenantCatalog(")
            .contains("String productLine")
